...
const PauseModal: React.FC<PauseModal> = ({ isVisible, onClose, onQuit, onRestart }) => {
    ...
    <Modal animationType="slide" transparent={true} visible={isVisible} onRequestClose={onClose}>
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.title}>{localization.t(LOCALIZATION_KEYS.TITLE_PAUSED)}</Text>
          <View style={styles.buttons}>
            <DefaultButton
              text={localization.t(LOCALIZATION_KEYS.BTN_RESTART_CHALLENGE)}
