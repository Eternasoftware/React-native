...
type LoginToWatchModalProps = {
  isVisible: boolean;
  onClose: () => void;
};

const LoginToWatchModal: React.FC<LoginToWatchModalProps> = ({ isVisible, onClose }) => {
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <View style={styles.textContent}>
            <Text style={styles.title}>{localization.t(LOCALIZATION_KEYS.TITLE_MODAL_ACCESS)}</Text>
            <Text style={styles.text}>{localization.t(LOCALIZATION_KEYS.TXT_MODAL_ACCESS)}</Text>
          </View>

          <View style={styles.buttons}>
            <DefaultButton
              text={localization.t(LOCALIZATION_KEYS.BTN_LOGIN)}
...
export default LoginToWatchModal;
